...
if(__cmp)
    ...
    configure_file(${CMAKE_SOURCE_DIR}/brandings/${BRANDING_VALUE}/banner.bmp ${CMAKE_SOURCE_DIR}/admin/win/msi/gui/banner.bmp)
    configure_file(${CMAKE_SOURCE_DIR}/brandings/${BRANDING_VALUE}/dialog.bmp ${CMAKE_SOURCE_DIR}/admin/win/msi/gui/dialog.bmp)
    configure_file(${CMAKE_SOURCE_DIR}/brandings/${BRANDING_VALUE}/installer-background.png ${CMAKE_SOURCE_DIR}/admin/osx/installer-background.png)
    configure_file(${CMAKE_SOURCE_DIR}/brandings/${BRANDING_VALUE}/installer-background_2x.png ${CMAKE_SOURCE_DIR}/admin/osx/installer-background_2x.png)
    ...
    configure_file(${CMAKE_SOURCE_DIR}/brandings/default/banner.bmp ${CMAKE_SOURCE_DIR}/admin/win/msi/gui/banner.bmp)
    configure_file(${CMAKE_SOURCE_DIR}/brandings/default/dialog.bmp ${CMAKE_SOURCE_DIR}/admin/win/msi/gui/dialog.bmp)
    configure_file(${CMAKE_SOURCE_DIR}/brandings/default/installer-background.png ${CMAKE_SOURCE_DIR}/admin/osx/installer-background.png)
    configure_file(${CMAKE_SOURCE_DIR}/brandings/default/installer-background_2x.png ${CMAKE_SOURCE_DIR}/admin/osx/installer-background_2x.png)
    configure_file(${CMAKE_SOURCE_DIR}/brandings/default/state-offline.svg ${CMAKE_SOURCE_DIR}/theme/colored/state-offline.svg)
    configure_file(${CMAKE_SOURCE_DIR}/brandings/default/wizard_logo.svg ${CMAKE_SOURCE_DIR}/theme/colored/wizard_logo.svg)
    configure_file(${CMAKE_SOURCE_DIR}/brandings/default/wizard-nextcloud.svg ${CMAKE_SOURCE_DIR}/theme/colored/wizard-nextcloud.svg)
endif()
